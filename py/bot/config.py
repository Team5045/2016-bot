...
DRIVE_RIGHT_ENCODER_A = 3
DRIVE_RIGHT_ENCODER_B = 4
DRIVE_LEFT_ENCODER_A = 5
DRIVE_LEFT_ENCODER_B = 6
DRIVE_ENCODER_DISTANCE_PER_PULSE = (math.pi * (6)) / 250  # Diameter (in) / ct

# Intake
INTAKE_MOTOR = 0
INTAKE_SOLENOID_FW = 0
INTAKE_SOLENOID_BW = 1
INTAKE_LOADED_LIMIT_SWITCH = 1
